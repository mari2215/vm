            ...
            <div class="col-lg-12">
              <div class="main-profile ">
                ...
                @if ($event->image)
                    ...
                    <div class="col-lg-4">
                    <img src="{{ asset('uploads/event/' . $event->image) }}" id = "image" class="rounded-left horizontal-img img-fluid w-100" style="border-radius: 16px; height:inherit;" alt="Image">
                    </div>
...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    this.page.url = "{{ url('/admin/view-event/' . $event->id) }}";  // Replace PAGE_URL with your page's canonical URL variable
