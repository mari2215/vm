...
<div class="container-fluid">
        <div class="container">
            <div class="text-center mb-5 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h1 class="display-5 w-50 mx-auto font-weight-bold">Додайте нову подію</h1>

                </div>
                <div class="">
                    <form class = "" action="{{url('admin/add-event')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="my-1">
                        ...
                        <div class="my-1">
                            <textarea id="photo_description" name="photo_description" class="form-control" rows="2" placeholder="Фото опис"></textarea>
                        </div>

                        <div class="my-1">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="video_url" name="video_url" placeholder="url відео">
                                </div>
                                <div class="col-lg-6">
                        ...
                        <input type="text"  id="marker_id" name="marker_id" class="form-control" aria-label="Recipient's username"
                            aria-describedby="basic-addon2" placeholder="Маркер ID" readonly>
